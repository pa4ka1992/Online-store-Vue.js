...
const randomQuotes = [
  'How do you even type this url? Are you drunk?',
  'Wait... Who stole the page?',
  'LMAO, OWN3D',
  'Nice url, but lets try to find who asked?',
